...
class MountainTitlePanel:
	...
	func _draw() -> void:
		...
		var card_size: Vector2 = Vector2(min(1180.0, s.x * 0.72), min(760.0, s.y * 0.76))
...
func create_title_screen() -> void:
	...
	title_start_button = make_title_button("DEPLOY", Vector2(-240.0, -120.0), Vector2(480.0, 62.0))
	title_start_button.pressed.connect(start_game_from_title)
	title_panel.add_child(title_start_button)

	title_shop_button = make_title_button("UPGRADE SHOP", Vector2(-240.0, -48.0), Vector2(480.0, 58.0))
	title_shop_button.pressed.connect(open_shop_from_title)
	title_panel.add_child(title_shop_button)

	title_achievements_button = make_title_button("ACHIEVEMENTS", Vector2(-240.0, 20.0), Vector2(480.0, 58.0))
	title_achievements_button.pressed.connect(open_achievements_from_title)
	title_panel.add_child(title_achievements_button)

	title_reset_progress_button = make_title_button("RESET SAVE", Vector2(-240.0, 88.0), Vector2(480.0, 58.0))
	...
	title_brief_button = make_title_button("MISSION BRIEF", Vector2(-240.0, 156.0), Vector2(480.0, 58.0))
	title_brief_button.pressed.connect(toggle_title_brief)
	title_panel.add_child(title_brief_button)

	title_mode_button = make_title_button(get_mode_button_text(), Vector2(-240.0, 224.0), Vector2(480.0, 58.0))
	title_mode_button.pressed.connect(cycle_game_mode)
	title_panel.add_child(title_mode_button)

	title_quit_button = make_title_button("QUIT", Vector2(-240.0, 292.0), Vector2(480.0, 58.0))
	...
	title_brief_label.offset_left = -520.0
	title_brief_label.offset_right = 520.0
	title_brief_label.offset_top = 370.0
	title_brief_label.offset_bottom = 520.0
