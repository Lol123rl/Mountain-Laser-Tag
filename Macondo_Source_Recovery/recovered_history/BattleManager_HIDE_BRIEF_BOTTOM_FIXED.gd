...
func create_title_screen() -> void:
	...
	title_brief_label.offset_top = -118.0
	title_brief_label.offset_bottom = 185.0
...
func show_title_screen() -> void:
	...
	if title_brief_button != null:
		title_brief_button.text = "MISSION BRIEF"
		title_brief_button.position = Vector2(-240.0, 120.0)
		title_brief_button.size = Vector2(480.0, 48.0)
	if online_panel != null:
		online_panel.visible = false
...
func toggle_title_brief() -> void:
	...
	if title_brief_button != null:
		...
		if title_brief_visible:
			title_brief_button.text = "HIDE BRIEF"
			title_brief_button.position = Vector2(-240.0, 292.0)
			title_brief_button.size = Vector2(480.0, 48.0)
		else:
			title_brief_button.text = "MISSION BRIEF"
			title_brief_button.position = Vector2(-240.0, 120.0)
...
func cycle_game_mode() -> void:
	...
	if title_brief_label != null:
		title_brief_label.text = get_title_brief_text()
	if title_brief_button != null and title_brief_visible:
		title_brief_button.position = Vector2(-240.0, 292.0)
		title_brief_button.size = Vector2(480.0, 48.0)
